        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
          <div>
            <div className="mb-5 md:mb-6">
              <div className="size-12 flex items-center justify-center rounded-lg bg-tahitigold text-white">
...
export const Layout24Defaults = {
  ...
  image: {
    src: "https://images.unsplash.com/photo-1632932197818-6b133cfbf56b?q=80&w=3272&auto=format&fit=crop",
