...
const IconWrapper = ({ icon: Icon }) => (
  <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-lg bg-gray md:mb-6">
        ...
        <div className="flex flex-col items-start">
          <div className="rb-12 mb-12 grid grid-cols-1 items-start justify-between gap-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
            <div>
              ...
              <h2 className="text-5xl font-bold text-black md:text-7xl lg:text-8xl">{heading}</h2>
            </div>
